...
/*
	...
	/*Version avec 05lx
	 *
	 * printf("valeur non compensée de la température %05lX \r\n",temp_uncompen);
	...
	*/
	...
	/*Récupérer valeurs compensées une seule fois hors boucle while
	 *
  ...
  /* USER CODE BEGIN WHILE */
	while (1)
	{
		...
		printf("valeur non compensée de la pression %d \r\n",pres_uncompen);
		printf("la pression compensée  %u (Output value of “24674867” represents 24674867/256 = 96386.2 Pa = 963.862 hPa)    \r\n",pres_comp);*/
